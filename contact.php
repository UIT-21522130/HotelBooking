    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 mb-5 px-4">
                ...
                <h5>Address</h5>
                <a href="<?php echo $contact_r['gmap'] ?>" targer="_blank" class="d-inline-block text-decoration-none text-dark mb-2">
                    <i class="bi bi-geo-alt-fill"></i> <?php echo $contact_r['address'] ?>
                </a>
                <h5 class="mt-4">Call us</h5>
                <a href="tel: <?php echo $contact_r['gmap'] ?>" class="d-inline-block mb-2 text-decoration-none text-dark">
