                ...
                <form action="">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <a href="javascript: void(0)" class="text-secondary text-decoration-none"> Forgot you password?</a>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" class="form-control shadow-none" name='dateofbirth' placeholder="Date of birth">                                
                            </div>
                            <div class="form-group mb-3">
